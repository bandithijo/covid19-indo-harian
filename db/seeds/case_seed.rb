...
data = Case.new(
  positif_covid:   396454,
  sembuh_covid:    322248,
  meninggal_covid: 13512,
  jumlah_suspek:   169479,
  jumlah_spesimen: 37438,
  fetched_at:      '2020-10-27'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   400483,
  sembuh_covid:    325793,
  meninggal_covid: 13612,
  jumlah_suspek:   169833,
  jumlah_spesimen: 40572,
  fetched_at:      '2020-10-28'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   404048,
  sembuh_covid:    329778,
  meninggal_covid: 13701,
  jumlah_suspek:   68888,
  jumlah_spesimen: 34317,
  fetched_at:      '2020-10-29'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   406945,
  sembuh_covid:    334295,
  meninggal_covid: 13782,
  jumlah_suspek:   68292,
  jumlah_spesimen: 24854,
  fetched_at:      '2020-10-30'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   410088,
  sembuh_covid:    337801,
  meninggal_covid: 13869,
  jumlah_suspek:   67900,
  jumlah_spesimen: 29001,
  fetched_at:      '2020-10-31'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   412784,
  sembuh_covid:    341942,
  meninggal_covid: 13943,
  jumlah_suspek:   61215,
  jumlah_spesimen: 23208,
  fetched_at:      '2020-11-01'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   415402,
  sembuh_covid:    345566,
  meninggal_covid: 14044,
  jumlah_suspek:   59500,
  jumlah_spesimen: 26661,
...
data = Case.new(
  positif_covid:   421731,
  sembuh_covid:    353282,
  meninggal_covid: 14259,
  jumlah_suspek:   56967,
  jumlah_spesimen: 40979,
  fetched_at:      '2020-11-04'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   425796,
  sembuh_covid:    357142,
  meninggal_covid: 14348,
  jumlah_suspek:   55943,
  jumlah_spesimen: 39481,
  fetched_at:      '2020-11-05'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   429574,
  sembuh_covid:    360705,
  meninggal_covid: 14442,
  jumlah_suspek:   56663,
  jumlah_spesimen: 38091,
  fetched_at:      '2020-11-06'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   433836,
  sembuh_covid:    364417,
  meninggal_covid: 14540,
  jumlah_suspek:   56461,
  jumlah_spesimen: 38249,
  fetched_at:      '2020-11-07'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   437716,
  sembuh_covid:    368298,
  meninggal_covid: 14614,
  jumlah_suspek:   57043,
  jumlah_spesimen: 38588,
  fetched_at:      '2020-11-08'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   440569,
  sembuh_covid:    372266,
  meninggal_covid: 14689,
  jumlah_suspek:   57925,
  jumlah_spesimen: 34365,
  fetched_at:      '2020-11-09'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   444348,
  sembuh_covid:    375741,
  meninggal_covid: 14761,
  jumlah_suspek:   55560,
  jumlah_spesimen: 33063,
  fetched_at:      '2020-11-10'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   448118,
  sembuh_covid:    378982,
  meninggal_covid: 14836,
  jumlah_suspek:   55982,
  jumlah_spesimen: 39341,
  fetched_at:      '2020-11-11'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   452291,
  sembuh_covid:    382084,
  meninggal_covid: 14933,
  jumlah_suspek:   56868,
  jumlah_spesimen: 42165,
  fetched_at:      '2020-11-12'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   457735,
  sembuh_covid:    385094,
  meninggal_covid: 15037,
  jumlah_suspek:   58896,
  jumlah_spesimen: 42333,
  fetched_at:      '2020-11-13'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   463007,
  sembuh_covid:    388094,
  meninggal_covid: 15148,
  jumlah_suspek:   61975,
  jumlah_spesimen: 41336,
  fetched_at:      '2020-11-14'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   467113,
  sembuh_covid:    391991,
  meninggal_covid: 15211,
  jumlah_suspek:   63380,
  jumlah_spesimen: 32861,
  fetched_at:      '2020-11-15'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   470648,
  sembuh_covid:    395443,
  meninggal_covid: 15296,
  jumlah_suspek:   63683,
  jumlah_spesimen: 34639,
  fetched_at:      '2020-11-16'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   474455,
  sembuh_covid:    398636,
  meninggal_covid: 15393,
  jumlah_suspek:   64928,
  jumlah_spesimen: 39772,
  fetched_at:      '2020-11-17'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   478720,
  sembuh_covid:    402347,
  meninggal_covid: 15503,
  jumlah_suspek:   64430,
  jumlah_spesimen: 41942,
  fetched_at:      '2020-11-18'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   483518,
  sembuh_covid:    406612,
  meninggal_covid: 15600,
  jumlah_suspek:   63546,
  jumlah_spesimen: 47630,
  fetched_at:      '2020-11-19'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   488310,
  sembuh_covid:    410552,
  meninggal_covid: 15678,
  jumlah_suspek:   63074,
  jumlah_spesimen: 41955,
  fetched_at:      '2020-11-20'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   493308,
  sembuh_covid:    413955,
  meninggal_covid: 15774,
  jumlah_suspek:   64317,
  jumlah_spesimen: 43122,
  fetched_at:      '2020-11-21'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   497668,
  sembuh_covid:    418188,
  meninggal_covid: 15884,
  jumlah_suspek:   64502,
  jumlah_spesimen: 35989,
  fetched_at:      '2020-11-22'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   502110,
  sembuh_covid:    422386,
  meninggal_covid: 16002,
  jumlah_suspek:   66279,
  jumlah_spesimen: 40083,
  fetched_at:      '2020-11-23'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   506302,
  sembuh_covid:    425313,
  meninggal_covid: 16111,
  jumlah_suspek:   64414,
  jumlah_spesimen: 39971,
  fetched_at:      '2020-11-24'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   511836,
  sembuh_covid:    429807,
  meninggal_covid: 16225,
  jumlah_suspek:   65438,
  jumlah_spesimen: 45330,
  fetched_at:      '2020-11-25'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   516753,
  sembuh_covid:    433649,
  meninggal_covid: 16352,
  jumlah_suspek:   66685,
  jumlah_spesimen: 51471,
  fetched_at:      '2020-11-26'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   522581,
  sembuh_covid:    437456,
  meninggal_covid: 16521,
  jumlah_suspek:   67836,
  jumlah_spesimen: 48823,
  fetched_at:      '2020-11-27'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   527999,
  sembuh_covid:    441983,
  meninggal_covid: 16646,
  jumlah_suspek:   68606,
  jumlah_spesimen: 46574,
  fetched_at:      '2020-11-28'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   534266,
  sembuh_covid:    445793,
  meninggal_covid: 16815,
  jumlah_suspek:   70792,
  jumlah_spesimen: 42903,
  fetched_at:      '2020-11-29'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   538883,
  sembuh_covid:    450518,
  meninggal_covid: 16945,
  jumlah_suspek:   72786,
  jumlah_spesimen: 40055,
  fetched_at:      '2020-11-30'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   543975,
  sembuh_covid:    454879,
  meninggal_covid: 17081,
  jumlah_suspek:   71286,
  jumlah_spesimen: 51232,
  fetched_at:      '2020-12-01'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   549508,
  sembuh_covid:    458880,
  meninggal_covid: 17199,
  jumlah_suspek:   71074,
  jumlah_spesimen: 58245,
  fetched_at:      '2020-12-02'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   557877,
  sembuh_covid:    462553,
  meninggal_covid: 17355,
  jumlah_suspek:   69027,
  jumlah_spesimen: 62397,
  fetched_at:      '2020-12-03'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   563680,
  sembuh_covid:    466178,
  meninggal_covid: 17479,
  jumlah_suspek:   69016,
  jumlah_spesimen: 59365,
  fetched_at:      '2020-12-04'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   569707,
  sembuh_covid:    470449,
  meninggal_covid: 17589,
  jumlah_suspek:   69926,
  jumlah_spesimen: 54922,
  fetched_at:      '2020-12-05'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   575796,
  sembuh_covid:    474771,
  meninggal_covid: 17740,
  jumlah_suspek:   70091,
  jumlah_spesimen: 50634,
  fetched_at:      '2020-12-06'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   581550,
  sembuh_covid:    479202,
  meninggal_covid: 17867,
  jumlah_suspek:   72986,
  jumlah_spesimen: 26873,
  fetched_at:      '2020-12-07'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   586842,
  sembuh_covid:    483497,
  meninggal_covid: 18000,
  jumlah_suspek:   70450,
  jumlah_spesimen: 52819,
  fetched_at:      '2020-12-08'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   592900,
  sembuh_covid:    487445,
  meninggal_covid: 18171,
  jumlah_suspek:   69879,
  jumlah_spesimen: 56034,
  fetched_at:      '2020-12-09'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   598933,
  sembuh_covid:    491975,
  meninggal_covid: 18336,
  jumlah_suspek:   66463,
  jumlah_spesimen: 31984,
  fetched_at:      '2020-12-10'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   605243,
  sembuh_covid:    496886,
  meninggal_covid: 18511,
  jumlah_suspek:   64845,
  jumlah_spesimen: 54072,
  fetched_at:      '2020-12-11'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   611631,
  sembuh_covid:    501376,
  meninggal_covid: 18653,
  jumlah_suspek:   62224,
  jumlah_spesimen: 59388,
  fetched_at:      '2020-12-12'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   617820,
  sembuh_covid:    505836,
  meninggal_covid: 18819,
  jumlah_suspek:   63598,
  jumlah_spesimen: 51048,
  fetched_at:      '2020-12-13'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   623309,
  sembuh_covid:    510957,
  meninggal_covid: 18956,
  jumlah_suspek:   64067,
  jumlah_spesimen: 42006,
  fetched_at:      '2020-12-14'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   629429,
  sembuh_covid:    516656,
  meninggal_covid: 19111,
  jumlah_suspek:   63666,
  jumlah_spesimen: 60700,
  fetched_at:      '2020-12-15'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   636154,
  sembuh_covid:    521984,
  meninggal_covid: 19248,
  jumlah_suspek:   62364,
  jumlah_spesimen: 61291,
  fetched_at:      '2020-12-16'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   643508,
  sembuh_covid:    526979,
  meninggal_covid: 19390,
  jumlah_suspek:   62250,
  jumlah_spesimen: 60629,
  fetched_at:      '2020-12-17'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   650197,
  sembuh_covid:    531995,
  meninggal_covid: 19514,
  jumlah_suspek:   62717,
  jumlah_spesimen: 67678,
  fetched_at:      '2020-12-18'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   657948,
  sembuh_covid:    536260,
  meninggal_covid: 19659,
  jumlah_suspek:   64071,
  jumlah_spesimen: 63768,
  fetched_at:      '2020-12-19'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   664930,
  sembuh_covid:    541811,
  meninggal_covid: 19880,
  jumlah_suspek:   64071,
  jumlah_spesimen: 66702,
  fetched_at:      '2020-12-20'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   671778,
  sembuh_covid:    546884,
  meninggal_covid: 20085,
  jumlah_suspek:   67509,
  jumlah_spesimen: 37445,
  fetched_at:      '2020-12-21'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   678125,
  sembuh_covid:    552722,
  meninggal_covid: 20257,
  jumlah_suspek:   69343,
  jumlah_spesimen: 49806,
  fetched_at:      '2020-12-22'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   685639,
  sembuh_covid:    558703,
  meninggal_covid: 20408,
  jumlah_suspek:   66914,
  jumlah_spesimen: 52672,
  fetched_at:      '2020-12-23'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   692838,
  sembuh_covid:    563980,
  meninggal_covid: 20589,
  jumlah_suspek:   68219,
  jumlah_spesimen: 61068,
  fetched_at:      '2020-12-24'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   700097,
  sembuh_covid:    570304,
  meninggal_covid: 20847,
  jumlah_suspek:   67464,
  jumlah_spesimen: 50393,
  fetched_at:      '2020-12-25'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   706837,
  sembuh_covid:    576693,
  meninggal_covid: 20994,
  jumlah_suspek:   68061,
  jumlah_spesimen: 44581,
  fetched_at:      '2020-12-26'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   713365,
  sembuh_covid:    583676,
  meninggal_covid: 21237,
  jumlah_suspek:   69325,
  jumlah_spesimen: 41963,
  fetched_at:      '2020-12-27'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   719219,
  sembuh_covid:    589978,
  meninggal_covid: 21452,
  jumlah_suspek:   69156,
  jumlah_spesimen: 34796,
  fetched_at:      '2020-12-28'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   727122,
  sembuh_covid:    596783,
  meninggal_covid: 21703,
  jumlah_suspek:   68181,
  jumlah_spesimen: 65143,
  fetched_at:      '2020-12-29'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   735124,
  sembuh_covid:    603741,
  meninggal_covid: 21944,
  jumlah_suspek:   67615,
  jumlah_spesimen: 72922,
  fetched_at:      '2020-12-30'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   743198,
  sembuh_covid:    611097,
  meninggal_covid: 22138,
  jumlah_suspek:   68316,
  jumlah_spesimen: 57800,
  fetched_at:      '2020-12-31'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   751270,
  sembuh_covid:    617936,
  meninggal_covid: 22329,
  jumlah_suspek:   86418,
  jumlah_spesimen: 40785,
  fetched_at:      '2021-01-01'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   758473,
  sembuh_covid:    625518,
  meninggal_covid: 22555,
  jumlah_suspek:   69619,
  jumlah_spesimen: 33530,
  fetched_at:      '2021-01-02'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   765350,
  sembuh_covid:    631937,
  meninggal_covid: 22734,
  jumlah_suspek:   72027,
  jumlah_spesimen: 41503,
  fetched_at:      '2021-01-03'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   772103,
  sembuh_covid:    639103,
  meninggal_covid: 22911,
  jumlah_suspek:   72380,
  jumlah_spesimen: 45868,
  fetched_at:      '2021-01-04'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   779548,
  sembuh_covid:    645746,
  meninggal_covid: 23109,
  jumlah_suspek:   70201,
  jumlah_spesimen: 60520,
  fetched_at:      '2021-01-05'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   788402,
  sembuh_covid:    652513,
  meninggal_covid: 23296,
  jumlah_suspek:   70029,
  jumlah_spesimen: 67908,
  fetched_at:      '2021-01-06'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   797723,
  sembuh_covid:    659437,
  meninggal_covid: 23520,
  jumlah_suspek:   68753,
  jumlah_spesimen: 68019,
  fetched_at:      '2021-01-07'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   808340,
  sembuh_covid:    666883,
  meninggal_covid: 23753,
  jumlah_suspek:   69121,
  jumlah_spesimen: 66619,
  fetched_at:      '2021-01-08'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   818386,
  sembuh_covid:    673511,
  meninggal_covid: 23947,
  jumlah_suspek:   69865,
  jumlah_spesimen: 57666,
  fetched_at:      '2021-01-09'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   828026,
  sembuh_covid:    681024,
  meninggal_covid: 24129,
  jumlah_suspek:   70381,
  jumlah_spesimen: 46025,
  fetched_at:      '2021-01-10'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   836718,
  sembuh_covid:    688739,
  meninggal_covid: 24343,
  jumlah_suspek:   68572,
  jumlah_spesimen: 38061,
  fetched_at:      '2021-01-11'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   846765,
  sembuh_covid:    695807,
  meninggal_covid: 24645,
  jumlah_suspek:   54827,
  jumlah_spesimen: 70309,
  fetched_at:      '2021-01-12'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   858043,
  sembuh_covid:    703464,
  meninggal_covid: 24951,
  jumlah_suspek:   59667,
  jumlah_spesimen: 71689,
  fetched_at:      '2021-01-13'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   869600,
  sembuh_covid:    711205,
  meninggal_covid: 25246,
  jumlah_suspek:   64032,
  jumlah_spesimen: 70376,
  fetched_at:      '2021-01-14'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   882418,
  sembuh_covid:    718696,
  meninggal_covid: 25484,
  jumlah_suspek:   66573,
  jumlah_spesimen: 72957,
  fetched_at:      '2021-01-15'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   896642,
  sembuh_covid:    727358,
  meninggal_covid: 25767,
  jumlah_suspek:   69414,
  jumlah_spesimen: 63300,
  fetched_at:      '2021-01-16'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   907929,
  sembuh_covid:    736460,
  meninggal_covid: 25987,
  jumlah_suspek:   73243,
  jumlah_spesimen: 46138,
  fetched_at:      '2021-01-17'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   917015,
  sembuh_covid:    745935,
  meninggal_covid: 26282,
  jumlah_suspek:   77579,
  jumlah_spesimen: 47488,
  fetched_at:      '2021-01-18'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   927380,
  sembuh_covid:    753948,
  meninggal_covid: 26590,
  jumlah_suspek:   76971,
  jumlah_spesimen: 70634,
  fetched_at:      '2021-01-19'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   939948,
  sembuh_covid:    763703,
  meninggal_covid: 26857,
  jumlah_suspek:   79418,
  jumlah_spesimen: 58805,
  fetched_at:      '2021-01-20'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   951651,
  sembuh_covid:    772790,
  meninggal_covid: 27203,
  jumlah_suspek:   79200,
  jumlah_spesimen: 67454,
  fetched_at:      '2021-01-21'
)
input_into_cases(data)

data = Case.new(
  positif_covid:   965283,
  sembuh_covid:    781147,
  meninggal_covid: 27453,
  jumlah_suspek:   79349,
  jumlah_spesimen: 77942,
  fetched_at:      '2021-01-22'
)
input_into_cases(data)
